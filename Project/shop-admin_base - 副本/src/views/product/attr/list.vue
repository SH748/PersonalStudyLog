    ...
    <el-card>
      ...
      <div v-show="!isShowAttrValueList">
        <el-form inline :model="formAttr">
          ...
          <!--表格-->
          <el-table :data="formAttr.attrValueList" style="width: 100%;margin-top:10px" border>
            <el-table-column type="index" label="序号" width="100"></el-table-column>
            <el-table-column prop="valueName" label="属性值"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    toUpdateAtrrValue(formAttr) {
      ...
      this.formAttr = lodash.cloneDeep(formAttr) // 克隆一个新的数据，如果数据修改后却没有保存，那么修改的数据不会影响原来的数据
      console.log(formAttr,this.formAttr)
      // 显示修改界面
