  ...
  <div id="box1">
    <div class="todo-container">
      <div class="todo-wrap">
        ...
        <foot :todos="todos" :doneAll="doneAll" :delAll="delAll" >
           <label slot="left">
          ...
          <button button class="btn btn-danger" @click="delAll" slot="right">清除已完成任务</button>
        </foot>
      </div>
    </div>
  </div>
